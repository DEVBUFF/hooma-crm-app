...
function AppleIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="#2E211C" aria-hidden="true">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "shadow-[0_1px_3px_rgba(46,33,28,0.04)]",
        "transition-all duration-200 ease-out",
        "hover:bg-[#EDE4D8] hover:shadow-[0_2px_6px_rgba(46,33,28,0.08)]",
